defmodule PetstoremanagerWeb.PetControllerTest do
  ...
  @create_attrs %{age: 120.5, breed: "some breed", name: "some name", owner: "some owner"}
  @update_attrs %{age: 456.7, breed: "some updated breed", name: "some updated name", owner: "some updated owner"}
  @invalid_attrs %{age: nil, breed: nil, name: nil, owner: nil}
